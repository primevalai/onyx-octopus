...
async def main():
    ...
    print(f"- ✓ Event creation and application to aggregates")
    print(f"- ✓ Event persistence and retrieval")
    print(f"- ✓ Aggregate versioning")
    print(f"- ✓ Business rule enforcement (email validation)")
    print(f"- ✓ Event ordering and consistency")
    print(f"- ✓ Version-based event loading")
